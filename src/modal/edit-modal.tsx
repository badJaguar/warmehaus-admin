...
const EditModal = (props: EditModalProps) => {
  const { mutateAsync: updateFloor, isLoading } = useUpdateFloor();
      ...
      >
        <Box sx={style}>
          ...
          >
            ...
            <LoadingButton loading={isLoading} sx={{ mt: 4 }} onClick={saveHandle} variant='contained'>Сохранить</LoadingButton>
          </Box>
        </Box>
      </Modal>
    </div>
